...
SCANNED ARTIFACT: LsassSilentProcessExit_process_exit_monitor_3001_lsass.evtx
...
* **Initial Detection**: 2021-06-08T22:18:11Z
* **Event Duration**: 0.004s (Engine Match Time)

## 3. [WHERE] INFILTRATION POINT
* **Origin**: Internal Node (Pivot Path Detected)
* **Target Artifact**: LsassSilentProcessExit_process_exit_monitor_3001_lsass.evtx
