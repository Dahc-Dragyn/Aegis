...
| 4 | `DE_EventLog_Service_Crashed.evtx` | =ï¿½ï¿½ï¿½ C (CAUTION) | AC-3: COMPLIANCE WARNING: Unauthorized Access / Lateral Movement | 4 | Unauthorized access attempts or unusual process execution in sensitive directories have been detected. This indicates a high risk of lateral movement across the network. |
