...
SCANNED ARTIFACT: cmd_dumping_ntds_dit_file_ntdsutil_cmd_dumping_ntds_dit_file_ntdsutil.json
...
* **Initial Detection**: 2026-05-09T10:00:56Z
* **Event Duration**: 0.004s (Engine Match Time)

## 3. [WHERE] INFILTRATION POINT
* **Origin**: Internal Node (Pivot Path Detected)
* **Target Artifact**: cmd_dumping_ntds_dit_file_ntdsutil_cmd_dumping_ntds_dit_file_ntdsutil.json
